...
async function updateUserInfomation() { //ใช้แสดงข้อมูล user ที่กำลังอยู่ใน session
    ...
    try { // ถ้า response ข้อมูลผู้ใช้ถูกต้อง ให้แสดงข้อมูลบนหน้าเว็บ
    ...
    } catch (e) { // ถ้า response ผิดพลาดหรือว่าง ให้แสดงข้อความ "ไม่สามารถแสดงผลข้อมุล"
        console.error(e);
